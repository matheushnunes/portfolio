        ...
        <main>
            <section className="apresentation">
                <div className="container-titles">
                    ...
                    <h3 className="flex-right typing-effect-bottom" id="apresentation-title-h3"><span className="color-blue">&lt;</span>Desenvolvedor Full-stack<span className="color-blue">/&gt;</span></h3>
                </div>
            ...
            >
                ...
                <div className="container-space-between container-about-text-btn">
                    <p className="text-about">
                        Estudo desenvolvimento de software desde 2021 e sou formado em <strong>Análise e Desenvolvimento de Sistemas</strong>. Tenho experiência prática na construção de interfaces modernas e fluidas, atuando com tecnologias como <strong>Angular, React, TypeScript e Tailwind CSS</strong>. Pela minha vivência como desenvolvedor full-stack em projetos de ERPs e módulos logísticos, consigo unir componentes responsivos no front-end a integrações eficientes com o back-end.
                    </p>
